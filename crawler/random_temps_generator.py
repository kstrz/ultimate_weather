...
for service in services:
    ...
    for x in reversed(range(30)):
        ...
        temps.h_01 = random.randint(0, 20)
        temps.h_02 = random.randint(0, 20)
        temps.h_03 = random.randint(0, 20)
        temps.h_04 = random.randint(0, 20)
        temps.h_05 = random.randint(0, 20)
        temps.h_06 = random.randint(0, 20)
        temps.h_07 = random.randint(5, 20)
        temps.h_08 = random.randint(10, 15)
        temps.h_09 = random.randint(10, 15)
        temps.h_10 = random.randint(15, 32)
        temps.h_11 = random.randint(15, 32)
        temps.h_12 = random.randint(15, 32)
        temps.h_13 = random.randint(15, 32)
        temps.h_14 = random.randint(15, 32)
        temps.h_15 = random.randint(15, 32)
        temps.h_16 = random.randint(15, 32)
        temps.h_17 = random.randint(15, 32)
        temps.h_18 = random.randint(15, 32)
        temps.h_19 = random.randint(10, 15)
        temps.h_20 = random.randint(10, 15)
        temps.h_21 = random.randint(10, 15)
        temps.h_22 = random.randint(0, 20)
        temps.h_23 = random.randint(0, 20)
        temps.h_24 = random.randint(0, 20)
